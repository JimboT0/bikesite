    ...
    <div>
      <div className='flex flex-row w-full'>
        ...
        <div className="w-full flex items-center justify-center py-24 ">
          <div className="max-w-md w-full p-6 border border-black dark:border-white rounded-md">
            <h1 className="text-3xl font-semibold mb-6 text-black dark:text-white text-center">Enquire</h1>
            <h1 className="text-sm font-semibold mb-6 text-gray-500 text-center">Get in touch with us. </h1>
