      ...
      <div className='flex flex-row'>
        ...
        <div className="w-full bg-gray-100 lg:w-1/2 flex items-center justify-center py-24">
          <div className="max-w-md w-full p-6">
            <h1 className="text-3xl font-semibold mb-6 text-black text-center">Sell</h1>
            <h1 className="text-sm font-semibold mb-6 text-gray-500 text-center">Thinking of selling your bike? Let us know  </h1>
